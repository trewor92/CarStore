...
namespace CarStoreRest.Tests.ControllersTests
{
    public class AccountControllerTests
    {
        ...
        {
            var createModel = new CreateModel { Name = "Test", Password = "Secret123$" };
        ...
        {
            var createModel = new CreateModel { Name = "NotValidName", Password = "NotValidPassword" };
        ...
        {
            var loginModel = new LoginModel { Name = "Test", Password = "Secret" };
